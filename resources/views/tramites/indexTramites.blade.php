        ...
        <div class="tramites-layout">
            ...
            <aside class="tramites-sidebar">
                ...
                <div class="tramites-sidebar-list">
                    ...
                    @foreach ($dependencias as $dependencia)
                        <button class="tramites-sidebar-item" type="button"
                            ...
                            <span
                                class="tramites-sidebar-count">{{ $tramites->where('fk_dependencia', $dependencia->id_dependencia)->count() }}</span>
                        </button>
                    @endforeach
                </div>
            </aside>
            ...
            <div class="tramites-content">
                ...
                <div class="tramites-tabs-mobile">
                    ...
                    @foreach ($dependencias as $dependencia)
                        <button class="tramites-tab-item" type="button"
                            data-dependencia="{{ $dependencia->id_dependencia }}">
                ...
                <div class="tramites-search">
                    <div class="search-bar">
                        ...
                        <input type="text" id="tramites-search-input" placeholder="Buscar trámite por nombre..."
                            autocomplete="off">
                        <button type="button" id="tramites-search-clear" class="search-clear" title="Limpiar búsqueda"
                            style="display: none">
                ...
                @else
                    <div class="tramites-grid">
                        @foreach ($tramites as $tramite)
                            @php
                                $requisitosTramite = $requisitosPorTramite[$tramite->id_tramite] ?? collect();
                                $totalRequisitos = $requisitosTramite->count();
                                $idCuerpo = 'collapse-tramite-' . $tramite->id_tramite;
                            @endphp

                            <div class="tramite-card" data-dependencia="{{ $tramite->fk_dependencia }}"
                                ...
                                <div class="accordion tramite-accordion">
                                    <div class="accordion-item">
                                        ...
                                        <div id="{{ $idCuerpo }}" class="accordion-collapse collapse" role="region"
                                            aria-label="Requisitos de {{ $tramite->nombre_tramite }}">
                                            <div class="accordion-body">
                                                @if ($requisitosTramite->isEmpty())
                                                    <div class="requisito-empty">
                                                        <i class="fa-solid fa-circle-info me-1"></i>
                                                        Este trámite no tiene requisitos registrados.
                                                    </div>
                                                @else
                                                    @foreach ($requisitosTramite as $requisito)
