        ...
        @php
            ...
            foreach ($predios as $predioTmp) {
                ...
                $documentosPrediosCompletadosGlobal += $catalogoPredios
                    ->filter(fn($doc) => $documentosPredioCargadosTmp->has($doc->id_documento_predio))
                    ->count();
            }
            $porcentajePredios =
                $totalDocumentosPrediosGlobal > 0
        ...
        <div class="profile-card">
            ...
            <div class="profile-card__datos">
                ...
                @if (auth()->user()->email_verified_at)
                    <span class="badge-verificacion badge-verificacion--ok"><i class="fas fa-circle-check me-1"></i>Correo
                        verificado</span>
                @else
                    <span class="badge-verificacion badge-verificacion--pendiente"><i
                            class="fas fa-circle-exclamation me-1"></i>Correo sin verificar</span>
                @endif
            </div>
        ...
        <div class="perfil-layout">
            <aside class="perfil-sidebar">
                ...
                <div class="perfil-sidebar__list" role="tablist" aria-label="Secciones del perfil">
                    <button
                        class="perfil-sidebar__item @if ($tabActiva === 'documentos') perfil-sidebar__item--active @endif"
                        role="tab" aria-selected="{{ $tabActiva === 'documentos' ? 'true' : 'false' }}"
                        aria-controls="panel-documentos" id="tab-documentos" data-seccion="documentos" type="button">
                    ...
                    <button
                        class="perfil-sidebar__item @if ($tabActiva === 'predios') perfil-sidebar__item--active @endif"
                        role="tab" aria-selected="{{ $tabActiva === 'predios' ? 'true' : 'false' }}"
                        aria-controls="panel-predios" id="tab-predios" data-seccion="predios" type="button">
                        <span class="perfil-sidebar__item-label">
            ...
            <div class="perfil-content">
                <div class="perfil-tabs-mobile">
                    <button class="perfil-tab-mobile @if ($tabActiva === 'documentos') perfil-tab-mobile--active @endif"
                        data-seccion="documentos" type="button">
                        <i class="fas fa-id-card me-1"></i>Documentos
                    </button>
                    <button class="perfil-tab-mobile @if ($tabActiva === 'predios') perfil-tab-mobile--active @endif"
                        data-seccion="predios" type="button">
                ...
                <div class="profile-tab-content" role="tabpanel" id="panel-documentos" aria-labelledby="tab-documentos"
                    @if ($tabActiva !== 'documentos') hidden @endif>
                    <div class="bento-grid">
                        <div class="documents-card documents-card--full">
                            ...
                            @if ($totalDocumentos > 0)
                                <div class="documents-card__progreso" data-seccion="documentos">
                                    <div class="documents-card__progreso-header">
                                        <span class="documents-card__progreso-label"><i
                                                class="fas fa-circle-check me-1"></i>Documentos completados</span>
                            ...
                            @if ($documentosCatalogo->isEmpty())
                                <p class="mensaje-vacio"><i class="fas fa-circle-info me-1"></i>No hay documentos
                                    personales disponibles en este momento.</p>
                            @else
                                    ...
                                    @foreach ($documentosCatalogo as $documento)
                                        ...
                                        <div class="documento-card {{ $cargado ? 'documento-card--cargado' : '' }}"
                                            ...
                                            <div class="documento-card__contenido">
                                                <span
                                                    class="documento-card__nombre">{{ $documento->nombre_documento }}</span>
                                                <div class="documento-card__meta">
                                                    @if (!$cargado || $estatus === 2)
                                                        <span class="documento-card__vigencia"><i
                                                                class="fas fa-hourglass-half me-1"></i>Vigencia:
                                                            {{ $documento->vigencia_meses }} meses</span>
                                                    @endif
                                                    @if ($cargado)
                                            ...
                                            <div class="documento-card__acciones">
                                                @if ($cargado)
                                                    ...
                                                    @elseif ($estatus === 1)
                                                        <span class="badge-estatus badge-estatus--revision"><i
                                                                class="fas fa-hourglass-half me-1"></i>En revisión</span>
                                                    @else
                                                        <span class="badge-estatus badge-estatus--rechazado"><i
                                                                class="fas fa-circle-xmark me-1"></i>Rechazado</span>
                                                    @endif
                                                    <a href="{{ route('descargarDocumento', $cargado->id_documento) }}"
                                                        class="btn-accion btn-accion--ver" target="_blank"
                                                        title="Ver documento">
                                                    ...
                                                    @if ($estatus === 0)
                                                        <form
                                                            ...
                                                            <input type="file" name="archivo"
                                                                class="input-archivo-oculto" accept=".pdf"
                                                                aria-label="Volver a subir {{ $documento->nombre_documento }}">
                                                            <button type="button"
                                                                class="btn-accion btn-accion--cargar btn-trigger-archivo"
                                                    ...
                                                    @endif
                                                @else
                                                    <span class="badge-estatus badge-estatus--pendiente"><i
                                                            class="fas fa-circle-exclamation me-1"></i>Pendiente</span>
                                                    <form action="{{ route('subirDocumento', $documento->id_documento) }}"
                                                        method="POST" enctype="multipart/form-data"
                                                        class="form-subir-inline">
                                                        @csrf
                                                        <input type="file" name="archivo" class="input-archivo-oculto"
                                                            accept=".pdf"
                ...
                <div class="profile-tab-content" role="tabpanel" id="panel-predios" aria-labelledby="tab-predios"
                    @if ($tabActiva !== 'predios') hidden @endif>
                    <div class="bento-grid">
                        <div class="documents-card documents-card--full">
                            <div class="documents-card__header">
                            ...
                            <form action="{{ route('agregarPredio') }}" method="POST" id="form-agregar-predio"
                                ...
                                <div class="form-agregar-predio__contenido">
                                    <div class="form-agregar-predio__campo">
                                        ...
                                        <div class="form-agregar-predio__input-wrap">
                                            ...
                                            <input type="text" name="clave_predio" id="clave_predio"
                                                value="{{ old('clave_predio') }}" placeholder="Ej. 123-456-789-000"
                                                maxlength="255" required>
                                        </div>
                                        <span class="form-agregar-predio__ayuda">Captura la clave tal como aparece en tu
                                            recibo predial o boleta.</span>
                                        @error('clave_predio')
                                    ...
                                    <div class="form-agregar-predio__acciones">
                                        ...
                                        <button type="button" class="btn-accion btn-accion--cancelar"
                                            id="btn-cancelar-form-predio">
                            ...
                            @if ($predios->isEmpty())
                                <p class="mensaje-vacio"><i class="fas fa-circle-info me-1"></i>Aún no has agregado
                                    predios a tu perfil.</p>
                            @else
...
@section('scripts')
    <script>
        window.perfilConfig = {!! json_encode([
